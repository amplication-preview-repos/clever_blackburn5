...
export class UserServiceBase {
  ...
  async DeleteComment(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async EditComment(args: UpdateCommentArgs): Promise<string> {
    throw new Error("Not implemented");
  }
  async EditOwnPost(args: PostUpdateInput): Promise<string> {
    throw new Error("Not implemented");
  }
  async FollowUser(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async UnfollowUser(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
}
