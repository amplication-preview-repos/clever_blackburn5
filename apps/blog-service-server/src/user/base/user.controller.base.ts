...
import { UpdateCommentArgs } from "../../comment/base/UpdateCommentArgs";
...
export class UserControllerBase {
  ...
  @common.Delete("/comments/:commentId")
  ...
  async DeleteComment(
    ...
    return this.service.DeleteComment(body);
  }

  @common.Patch("/comments/:commentId/edit")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async EditComment(
    @common.Body()
    body: UpdateCommentArgs
  ): Promise<string> {
    return this.service.EditComment(body);
  }

  @common.Patch("/posts/:postId/edit")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async EditOwnPost(
    ...
    return this.service.EditOwnPost(body);
  }

  @common.Post("/users/:userId/follow")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  @common.Post("/users/:userId/unfollow")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
